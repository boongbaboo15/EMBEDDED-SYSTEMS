...
#define WebHooksEventName_line "Data Logger and Social Alarm"
...
String httpRequestData = "&value1=" + String(My_NAME) + "&value2=" + String(temperature) + "&value3=" + String(humidity);
Serial.println();
