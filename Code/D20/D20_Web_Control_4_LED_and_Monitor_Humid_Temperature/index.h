...
<button type="button" onclick="sendData(41)" style="background: rgb(202,60,60);">LED4 ON</button><br><br>
...
<button type="button" onclick="sendData(40)" style="background: rgb(100,116,255);">LED4 OFF</button><br><br>
State of [LED1, LED2,LED3,LED4] is >> <span id="LEDState">NA</span><br></div><div><br>
DHT-22 sensor : <span
...
</script><br><a href="https://www.facebook.com/BenzPratchaya">Benz Pratchaya</a></body></html>)=====";
